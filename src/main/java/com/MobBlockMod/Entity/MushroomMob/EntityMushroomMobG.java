...
public class EntityMushroomMobG extends EntityTameable{

	public EntityMushroomMobG(World par1World) {
		super(par1World);
		...
		this.tasks.addTask(3, new EntityAIMate(this, 1.15D));
		this.tasks.addTask(4, new EntityAIFollowParent(this, 0.75F));
	...
	protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        if (i == 1) {
        	this.dropItem(MyCode.mushroomCap, 1);
        }
        int j = rand.nextInt(3);
        if(j == 1){
        	this.dropItem(MyCode.mushroomStem, 1);
        }
    }
	...
	public boolean interact(EntityPlayer p_70085_1_)
    {
        ...
        if (itemstack != null && itemstack.getItem() == MyCode.mushroomCompound && this.isTamed() == true){
        	this.heal(15.0F);
        }

        if (itemstack != null && itemstack.getItem() == MyCode.mushroomCompound && this.isTamed() == false)
        {
