...
public class EntityMushroom {
	...
	public static void registerEntity(boolean spawn) {
		...
		if (spawn) {
			EntityRegistry.addSpawn(EntityMushroomMob.class, 19, 1, 25, EnumCreatureType.AMBIENT, Biomes.FOREST, Biomes.BIRCH_FOREST, Biomes.BIRCH_FOREST_HILLS, Biomes.COLD_TAIGA, Biomes.COLD_TAIGA_HILLS, Biomes.EXTREME_HILLS, Biomes.EXTREME_HILLS_EDGE, Biomes.EXTREME_HILLS_WITH_TREES, Biomes.FOREST_HILLS, Biomes.JUNGLE, Biomes.JUNGLE_EDGE, Biomes.JUNGLE_HILLS, Biomes.ROOFED_FOREST, Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU, Biomes.TAIGA_HILLS, Biomes.TAIGA);
	...
	public static void createEntity(Class entityClass, String entityName, int solidColor, int spotColor){
		...
		ResourceLocation name = new ResourceLocation(MobBlockMod.MODID);
		EntityRegistry.registerModEntity(name, entityClass, entityName, randomId, MobBlockMod.instance, 64, 1, true, solidColor, spotColor);
	}
