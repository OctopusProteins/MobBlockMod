...
public class MBMWorldGenNetherMinable extends WorldGenerator
{
    ...
    public MBMWorldGenNetherMinable(IBlockState p_i45630_1_, int p_i45630_2_)
    {
        this(p_i45630_1_, p_i45630_2_, BlockMatcher.forBlock(Blocks.netherrack));
    }

    public MBMWorldGenNetherMinable(IBlockState p_i45631_1_, int p_i45631_2_, Predicate p_i45631_3_)
    {
